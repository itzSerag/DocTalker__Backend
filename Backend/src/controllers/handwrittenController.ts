...
export const uploadHandwrittenPDF = catchAsync(async (req: Request, res: Response, next: NextFunction) => {
    ...
    const dataLocation = await uploadFile(file.originalname, file.buffer, file.mimetype, userFolder);
...
export const uploadHandwrittenPic = (_req: Request, res: Response): void => {
