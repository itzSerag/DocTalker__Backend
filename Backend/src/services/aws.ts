import { DeleteObjectCommand, ListObjectsCommand, GetObjectCommand } from '@aws-sdk/client-s3';
...
export const uploadFolder = async (
    ...
    for (const file of files) {
        const uploaded = await uploadFile(file.originalname, file.buffer, file.mimetype, folderPath);
