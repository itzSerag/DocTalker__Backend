...
import { createCheckoutSession, paymentSuccess, paymentCancel } from '../controllers/paymentController';
...
// Initiate checkout
router.post('/process-payment', auth, isUserValid, paymentsCheck, createCheckoutSession);
